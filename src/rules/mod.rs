// building/vehicle/way/good の検証ロジック（cursor/icon省略時のスキップ、タイル画像欠落時の
...
// clip_belowクランプ、goodのfatal/warning分岐皆無の確認等）は、いずれもmakeobjの
// building_writer.cc / vehicle_writer.cc / way_writer.cc / good_writer.cc /
// get_waytype.cc / xref_writer.cc / tabfile.cc をソースとして直接ミラーしている。
//
// 検証済み:
